...
- **GPU 1 (the original 3090) is running hot** — 81 °C at *idle* on 2026-09-21 vs 57 °C on the new card (both at the 220 W limit, ~195 W drawn). Power limits were dropped from 250 W (set 2026-09-08, +6.2–6.5% prefill at equal stability) back to **220 W per card until the card is serviced** (thermal paste + pad replacement). 250 W is the documented target again once repasted.
