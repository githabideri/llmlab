...
| [Qwen3.8-27B (3-bit)](models/qwen3.8-27b-gsqrco-single3060.md) | IQ3_XXS (ISTA GSQ-RCO) | 1× RTX 3060 (secondary box + backup box) | 64K | llama.cpp D-CFR build + MTP, on-demand via each box's model-mux, ~25–29 t/s — since 2026-09-19 ([report](reports/2026-09-18-ista-3bit-27b-single-3060.md)) |
| [Qwen3.8-Flash-Next (Qwen4Exp)](models/qwen3.8-flash-next.md) | UD-Q2_K_XL + 64-slot MoE cache | 1× RTX 3060 (backup box, nightly window) | 64K | on-demand 125B/6B-active via the box's model-mux, ~14.5 t/s, text-only — since 2026-09-20 |
